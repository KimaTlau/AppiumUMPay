...
echo NOTE: This walks every money form in one go, on the one device this suite has. It takes a while.
echo.
echo Running End_To_End_TC_001 on the attached device ...
echo.
echo An Appium server must be listening on 127.0.0.1:4723 and a device attached.
echo.

call mvn test -Dcucumber.filter.tags="@End_To_End_TC_001"
